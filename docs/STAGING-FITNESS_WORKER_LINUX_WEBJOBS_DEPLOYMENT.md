...
## Staging — You already have the App Service (Code, Linux)

Do the following **in this order** in [Azure Portal](https://portal.azure.com/) → open your **staging** **Linux** Web App.
